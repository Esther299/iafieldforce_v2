import type { VisitSession, Channel, CtaType } from "@/shared/types";
import { generateGovernedReply, startVisitOpening } from "@/features/governance/lib/governance";
import { uid, msg } from "@/shared/lib/store-utils";
