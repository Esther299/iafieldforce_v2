...
const nav = [
  ...
  { to: "/creacion-del-equipo", label: "Creaci├│n del Equipo", icon: Users },
  { to: "/academia", label: "Academia", icon: GraduationCap },
  { to: "/compliance", label: "Compliance", icon: CheckCircle2 },
  { to: "/productos", label: "Productos", icon: Package },
  { to: "/campanas", label: "Campa├▒as", icon: Megaphone },
  { to: "/crm", label: "CRM", icon: Contact },
  { to: "/analitica", label: "Anal├¡tica", icon: BarChart3 },
  { to: "/creditos", label: "Cr├®ditos", icon: Wallet },
];
...
const quickLinks = [
  ...
  { to: "/prueba", label: "Test de campa├▒a" },
];
...
// Mapeo de informaci├│n de usuario seg├║n el rol activo
const userInfoMap: Record<UserRole, { name: string; roleTitle: string }> = {
  ...
  compliance: { name: "Mar├¡a Jos├®", roleTitle: "Gerente de Compliance" },
};
  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        <aside
          className={cn(
            // 1. Convertimos el aside en flex-col para apilar los elementos verticalmente de forma s├│lida
        ...
        >
          ...
          {/* Tarjeta de identificaci├│n del usuario con fondo gris azulado */}
          ...
          {/* 2. Ajustamos la navegaci├│n para que tome el espacio flexible y haga scroll interno si es necesario */}
          ...
          {/* 3. Quitamos 'absolute bottom-4 left-4 right-4' y dejamos que fluya de manera est├ítica al final */}
          <div className="mt-4 hidden rounded-2xl bg-gradient-to-br from-ink-800 to-ink-900 p-3 text-white shadow-lg md:block">
            <p className="text-xs font-semibold">­ƒö¼ IA Fieldforce</p>
